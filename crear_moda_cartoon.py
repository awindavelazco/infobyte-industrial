...
class FashionCartoonEngine:
    ...
    def generate_fashion_script(self):
        print("[DIRECTOR] Diseñando guion de Moda Estilo Cartoon Hero (Sincronización Dinámica)...")
        ...
        Your goal is to create a dynamic visual montage in Pixar/Disney 3D style that translates futuristic fashion into a powerful human transformation journey.

        THEME: Futuristic Fashion Design - The creation of a light-based masterpiece.
        CHARACTER: Lumina - A young tech-fashionista, large expressive eyes, glowing cyan fiber-optic hair, athletic build, determined expression.
        ...
        1. CLIP 1 (HOOK: 0-6s) -> MACRO/CLOSE-UP. High-impact detail. Lumina's eyes reflecting digital patterns. Dim workshop. Casual tech-wear.
        2. CLIP 2 (TENSION: 6-12s) -> MEDIUM SHOT. Struggle. Lumina fighting with a flickering hologram mannequin. Sparks flying. New outfit.
        3. CLIP 3 (REVELATION: 12-18s) -> INSERT SHOT. 'Aha!' moment. Lumina's finger pressing a glowing gold button on her glove. Hopeful light. Third outfit.
        4. CLIP 4 (EXPANSION: 18-24s) -> WIDE SHOT. Applying solution. A magnificent glowing holographic dress swirls around her. Vibrant golden light. Confident outfit.
        5. CLIP 5 (IMPACT: 24-30s) -> EPIC SLOW-MOTION CLOSE-UP. Final resolution. Lumina posing with her glowing masterpiece. Breathtaking ethereal setting. Elegant fiber-optic outfit.
        ...
        - BE CONCISE: Each clip prompt MUST be under 300 characters.
        - NO CONTINUITY STRINGS: Do NOT use 'Continuing from previous clip'.
        - CHARACTER CONSISTENCY: Repeat the exact core physical traits (fiber-optic hair, expressive eyes) in every clip, but change clothing and location.
        ...
        JSON STRUCTURE:
        {{
           "topic_es": "Moda Futurista - El Vestido de Luz",
...
def main():
    engine = FashionCartoonEngine()
    print("\n[👗] Generando Video de Moda — Estilo: Cartoon Hero (Técnica: Montaje Dinámico 5x6s)...")
    v = engine.generate_fashion_script()

    if v:
        v['id'] = 1
        engine.print_video_summary(v, 1)

        output_path = os.path.join(BASE_DIR, "video_moda_cartoon.json")
        ...
        print(f"\n[✅ ÉXITO] Guion guardado en: {output_path}")

        print("\n[🔍 QA] Iniciando Auditoría Automática de Calidad...")
        auditor_videos.main()
    else:
        print("\n[❌ FALLO] No se pudo generar el guion de video.")
