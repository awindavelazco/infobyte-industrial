...
function openModal(index) {
    ...
    document.getElementById('modalCategory').innerText = `#${displayId} | ` + (item.category || item.topic || item.topic_es || 'Infobyte Content');
    document.getElementById('modalTitle').innerText = item.title || item.headline || item.topic_es || '';
